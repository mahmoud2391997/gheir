...
export type ProductDocument = { name: string; slug: string; category: string; price: number; currency: string; stock: number; status: "published" | "draft"; imageKey?: string; imageUrl?: string; description?: string; createdAt: Date; updatedAt: Date };
