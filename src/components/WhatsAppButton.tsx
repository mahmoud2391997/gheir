...
export function WhatsAppButton() {
  ...
  const { t } = useLocale();
  return (
    <div className="fixed bottom-5 start-5 z-[60] flex flex-col items-start gap-2 sm:start-auto sm:end-5 sm:items-end">
      <a
        href={WHATSAPP_URL}
        target="_blank"
        rel="noreferrer"
      ...
      >
        ...
        <span className="hidden font-mono text-[11px] tracking-[0.16em] uppercase sm:inline">{t.openWhatsApp}</span>
      </a>
      <button
        type="button"
